...
class TransactionRepository(BaseRepository[Transaction]):
    ...
    def search(self, user_id: UUID, search_params: TransactionSearch) -> List[Transaction]:
        ...
        if search_params.has_installments is not None:
            query = query.filter(Transaction.has_installments == search_params.has_installments)
    ...
    def get_by_date_range(self, user_id: UUID, date_from: str, date_to: str) -> List[Transaction]:
